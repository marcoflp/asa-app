...
return [
    ...
    | as regras de tamanho. Sinta-se à vontade para ajustar qualquer uma dessas mensagens aqui.
    |
    */
    ...
    'any_of' => 'O campo :attribute deve ser um dos valores permitidos.',
    ...
    */
    ...
    'custom' => [
        ...
        'items' => [
            'min' => 'Adicione ao menos um item à retirada.',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para trocar nossos marcadores de posição de atributo
    ...
    */
    ...
    'attributes' => [
        ...
        'rg' => 'RG',
        'cpf' => 'CPF',
        'foto_documento' => 'foto do documento (frente)',
        'foto_documento_verso' => 'foto do documento (verso)',
        'foto_documento_consentimento' => 'termo de consentimento',
        'foto_documento_comprovante_residencia' => 'comprovante de residência',
        'num_pessoas_familia' => 'número de pessoas na família',
        'filhos' => 'filhos',
        'filhos.*.idade' => 'idade do filho',
        'inscrito_programa_governo' => 'programa do governo',
        'programa_governo' => 'nome do programa do governo',
        'recebe_estudo_biblico' => 'estudo bíblico',
        'instrutor_biblico' => 'instrutor bíblico',
        'name' => 'nome',
        'email' => 'e-mail',
        'password' => 'senha',
        ...
        'setupData' => 'dados de configuração',
    ],
